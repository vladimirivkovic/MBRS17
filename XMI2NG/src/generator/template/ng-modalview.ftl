...
<div>
	...
	<div class="modal-body" id="modal-body">
		...
		<table class="table">
			<#list fieldGroups?keys as fg>
			<tr><th>${fg}</th><td></td></tr>
			
	    		<#list fieldGroups[fg] as property>
					...
					<tr>
						<td>${property.originName} <#if property.lower == 1> <span style="color: red">*</span> </#if></td>
